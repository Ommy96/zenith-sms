...
function ProductPreview({ type }: { type: "fees" | "academics" | "messages" }) {
  return (
    <div className="relative min-h-[330px] overflow-hidden rounded-xl border border-border bg-card p-5 shadow-md sm:p-7">
      ...
      {type === "fees" && <div className="grid gap-3 pt-5 sm:grid-cols-2"><div className="rounded-lg border border-border bg-background p-4"><ReceiptText className="text-primary" /><p className="mt-7 text-xs text-muted-foreground">COLLECTED THIS TERM</p><p className="mt-1 font-mono text-2xl font-medium">KES 2.48M</p></div><div className="rounded-lg border border-border bg-background p-4"><BarChart3 className="text-success" /><div className="mt-8 flex h-20 items-end gap-2"><span className="h-[45%] flex-1 rounded-t-sm bg-primary/70" /><span className="h-[72%] flex-1 rounded-t-sm bg-primary/70" /><span className="h-[58%] flex-1 rounded-t-sm bg-primary/70" /><span className="h-[90%] flex-1 rounded-t-sm bg-primary/70" /><span className="h-[76%] flex-1 rounded-t-sm bg-primary/70" /></div></div><div className="rounded-lg border border-border bg-background p-4 sm:col-span-2"><div className="flex items-center justify-between text-sm"><span>M-Pesa payment matched</span><span className="font-mono text-success">+24,000</span></div></div></div>}
      {type === "academics" && <div className="space-y-3 pt-5"><div className="rounded-lg border border-border bg-background p-4"><div className="flex items-center justify-between text-sm"><span>Communication & collaboration</span><span className="font-mono text-primary">82%</span></div><div className="mt-3 h-1.5 overflow-hidden rounded-full bg-muted"><div className="h-full w-[82%] rounded-full bg-primary" /></div></div><div className="rounded-lg border border-border bg-background p-4"><div className="flex items-center justify-between text-sm"><span>Critical thinking</span><span className="font-mono text-primary">74%</span></div><div className="mt-3 h-1.5 overflow-hidden rounded-full bg-muted"><div className="h-full w-[74%] rounded-full bg-primary" /></div></div><div className="rounded-lg border border-border bg-background p-4"><div className="flex items-center justify-between text-sm"><span>Digital literacy</span><span className="font-mono text-primary">88%</span></div><div className="mt-3 h-1.5 overflow-hidden rounded-full bg-muted"><div className="h-full w-[88%] rounded-full bg-primary" /></div></div></div>}
